...
#ifndef JT07022008_events_date_time_HPP_DEFINED
#define JT07022008_events_date_time_HPP_DEFINED
...
struct date_time::ev::sel_change   : event_module_base {
};
struct date_time::ev::drop_down   : event_module_base {
    void init_event();
    /// if true, it's dropped, if false, it's closed
    read_only<bool> dropped;
};
struct date_time::ev::focus   : event_module_base {
    void init_event();
